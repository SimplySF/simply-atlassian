...
> Run `npm uninstall -g @simplysf/simply-atlassian` and install `@simplysf/simply-cli` instead.
> **Your commands do not change** — `simply atlassian …` is exactly what it was.
