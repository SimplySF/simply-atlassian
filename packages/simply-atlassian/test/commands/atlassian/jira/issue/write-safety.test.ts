  ...
  it('tests every command that declares itself a write', async () => {
    ...
    expect(declared.toSorted()).toEqual(
      [
        ...
        'atlassian/confluence/page/label/add.ts',
        'atlassian/jira/issue/remotelink/create.ts',
        'atlassian/jira/issue/remotelink/delete.ts',
        'atlassian/jira/sprint/create.ts',
        'atlassian/jira/sprint/update.ts',
