...
| `markdownToStorage(markdown)`                                                                                                                   | Converts Markdown to Confluence storage format — the reverse of `storageToMarkdown`, and what `--markdown`/`--markdown-file` on the page and comment write commands go through. Headings, emphasis, lists, links, tables, and code blocks; Confluence macros have no Markdown form. |
...
| `CreateIssueInput`, `UpdateIssueInput`, `IssueFieldInput`, `IssueReadBack`, `DeleteIssueInput`, `DeleteIssueResult`, `TransitionInput`, `TransitionsResponse`                                  | Input and result types for the issue operations.                                                           |
| `CommentInput`, `DeleteCommentInput`, `DeleteCommentResult`, `IssueLinkRequest`, `IssueLinkCreated`, `DeleteIssueLinkResult`, `SprintAddResult`, `JiraUser`, `ChangelogJson`                   | Input and result types for the comment, link, sprint, user, and history operations.                        |
| `CreatePageInput`, `UpdatePageInput`, `PageBodyInput`, `PageUpdatePlan`, `DeletePageInput`, `DeletePageResult`, `ConfluencePageSummary`, `BodyFormat`                                          | Input and result types for the Confluence page operations, and the body format a read renders to.          |
